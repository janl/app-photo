...
(function() {
...
}, "controllers/account": function(exports, require, module) {(function() {
  var Account, Spine,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Account = (function(_super) {
    ...
    function Account() {
      this.hide_login = __bind(this.hide_login, this);
      Account.__super__.constructor.apply(this, arguments);
      this.render();
    }

    Account.prototype.active = function(params) {
      Spine.hoodie.my.account.signOut();
      return Account.__super__.active.apply(this, arguments);
    };

    Account.prototype.render = function() {
      return this.el.html(require('views/login')(this));
    };

    Account.prototype.sign_up_or_in = function(event) {
      var email, password, sign_in_promise,
        _this = this;
      event.preventDefault();
      this.$email || (this.$email = this.$('input[name=email]'));
      this.$password || (this.$password = this.$('input[name=password]'));
      email = this.$email.val();
      password = this.$password.val();
      sign_in_promise = Spine.hoodie.my.account.signIn(email, password);
      sign_in_promise.done(this.hide_login);
      return sign_in_promise.fail(function() {
        var sign_up_promise;
        sign_up_promise = Spine.hoodie.my.account.signUp(email, password);
        sign_up_promise.done(_this.hide_login);
        return sign_up_promise.fail(function() {
          return alert('oops, something went wrong, buddy! Maybe try again?');
        });
      });
    };

    Account.prototype.hide_login = function() {
  ...
  Home = (function(_super) {
    ...
    Home.prototype.render = function() {
      return this.el.html(require('views/stream')(this));
    };

    Home.prototype["delete"] = function(event) {
      var id;
  ...
  var Image, ImageController, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  ImageController = (function(_super) {
    ...
    ImageController.prototype.render = function() {
      console.log('render');
      return this.html(require('views/image')(this));
    };

    ImageController.prototype.active = function(params) {
      this.record = Image.find(params.id);
      this.render();
      return ImageController.__super__.active.apply(this, arguments);
    };
...
}, "controllers/image_drop": function(exports, require, module) {(function() {
  var Image, ImageDrop, Spine,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  ImageDrop = (function(_super) {

    __extends(ImageDrop, _super);

    ImageDrop.prototype.events = {
      'dragenter': 'dragenter',
      'dragleave': 'dragleave',
      'drop': 'drop'
    };
    ...
    function ImageDrop() {
      ...
      ImageDrop.__super__.constructor.apply(this, arguments);
    }

    ImageDrop.prototype.drop = function(event) {
      var file, _i, _len, _ref, _results;
      event.preventDefault();
      this.el.removeClass('drag-hover');
      _ref = event.originalEvent.dataTransfer.files;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        file = _ref[_i];
        _results.push(this._loadFile(file));
      }
      return _results;
    };

    ImageDrop.prototype.dragenter = function(event) {
      return this.el.addClass('drag-hover');
    };

    ImageDrop.prototype.dragleave = function(event) {
      return this.el.removeClass('drag-hover');
    };

    ImageDrop.prototype._loadFile = function(file) {
      var reader,
        _this = this;
      console.log('_loadFile', file);
      reader = new FileReader;
      reader.onload = function(event) {
        var image_object, _attachments;
        image_object = {
          name: file.name,
          filename: file.name,
          size: file.size,
        ...
        return Spine.hoodie.my.store.save(image_object.type, image_object.id, image_object).done(function(object) {
          console.log('refresh!!', $.extend({
            _url: event.target.result
          }, object));
          Image.refresh($.extend({
            _url: event.target.result
          }, object));
          object._attachments = _attachments;
          return Spine.hoodie.my.remote.push([object]).done(function() {
            return console.log('image uploaded', object, arguments);
          }).fail(function() {
            return console.log('image upload failed', object, arguments);
          });
        });
      };
  ...
  var App, Hoodie, ImageDropController, Spine, config,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  App = (function(_super) {
    ...
    function App(options) {
      this.show_home = __bind(this.show_home, this);

      this.show_login = __bind(this.show_login, this);
      App.__super__.constructor.apply(this, arguments);
      Spine.Route.setup({
        trigger: true
      });
      Spine.hoodie.my.account.authenticate().done(this.show_home).fail(this.show_login);
      new ImageDropController({
        el: this.el
      });
    }

    App.prototype.show_login = function() {
      return this.navigate('/login', true);
    };

    App.prototype.show_home = function() {
      return this.navigate('/', true);
    };

    App.prototype._navigate = function(event) {
      var $a, href;
  ...
  config = location.hostname === 'hoodiehq.github.com' ? {
    env: 'production',
...
}, "lib/spine-hoodie": function(exports, require, module) {(function() {
...
}, "models/image": function(exports, require, module) {(function() {
  var Image, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Image = (function(_super) {
    ...
    Image.configure('Image', 'name', 'filename', 'size', 'description');

    Image.extend(Spine.Model.Hoodie);

    Image.all = function() {
      var records;
      records = Image.__super__.constructor.all.apply(this, arguments);
    ...
    Image.prototype.url = function() {
      ...
      return "" + baseURL + "/" + (encodeURIComponent(Spine.hoodie.my.account.db())) + "/image%2f" + this.id + "/" + (this.filename || this.name);
    };
...
}, "views/drop-overlay": function(exports, require, module) {module.exports = function(values){ 
  var $  = jQuery, result = $();
  ...
  (function() {
    (function() {
      ...
      __out.push('<div class="drop-overlay"></div>');
  ...
  return result;
};}, "views/image": function(exports, require, module) {module.exports = function(values){ 
  var $  = jQuery, result = $();
  values = $.makeArray(values);
  ...
  (function() {
    (function() {
      ...
      __out.push(this.record.url());
    
      __out.push('" />\n</div>\n<div id="pager">\n    <div class="prevnext"></div>\n    <div class="prevnext"></div>\n    <div class="prevnext"></div>\n    <div class="clear"></div>\n</div>\n<div id="detail">\n    <h1>');
    
      __out.push(__sanitize(this.record.name));
    
      __out.push('</h1>\n    <p>');
    
      __out.push(__sanitize(this.record.description));
    
      __out.push('</p>\n\n    <div id="comments">\n        <h3>Comments</h3>\n\n        <div class="comment">\n            <p><span class="from">@janl:</span>\n            Great Shot!</p>\n        </div>\n\n        <div class="comment">\n            <p><span class="from">@docbrown:</span>\n            Great Scott!</p>\n        </div>\n\n        <div class="comment">\n            <p><span class="from">@tigerwoods:</span>\n            Nice hole. I especially like the blurry wall artefacts and the lens flare.</p>\n        </div>\n\n        <div class="new-comment">\n            <textarea></textarea>\n            <br>\n            <input type="submit" value="Send" />\n        </div>\n\n    </div>\n</div>');
  ...
  return result;
};}, "views/login": function(exports, require, module) {module.exports = function(values){ 
  var $  = jQuery, result = $();
  values = $.makeArray(values);
  ...
  return result;
};}, "views/stream": function(exports, require, module) {module.exports = function(values){ 
  var $  = jQuery, result = $();
  values = $.makeArray(values);
  ...
  (function() {
    (function() {
      ...
      __out.push("mailto:dbf90f06b4b0807ed39a8d4686cb5f43+" + (Spine.hoodie.my.account.db()) + "@inbound.postmarkapp.com?subject=photo name here&body=photo description here");
    
      __out.push('\'>send email</a>)</small>\n</h1>\n</header>\n<section id="stream">\n    ');
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        __out.push(image.id);
        __out.push('">\n                <img src="');
        __out.push(image.url());
        __out.push('" />\n                <figcaption>\n                  ');
        __out.push(__sanitize(image.name));
